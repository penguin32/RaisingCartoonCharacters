...
function Layer1:new(x,y,scale)
	...
	Rectangle(
		self.x-100,
		self.y+self.waf:getHeight()+100,
		100,
		self.waf:getHeight()+200,
		1,
		true
	))--left side
	table.insert(LevelLoader.objects,Rectangle(self.x+self.waf:getWidth(),self.y+self.waf:getHeight()+100,100,self.waf:getHeight()+200,1,true))--right side
	table.insert(LevelLoader.objects,Rectangle(self.x-100,self.y,self.waf:getWidth()+200,100,1,true)) --top side
	table.insert(LevelLoader.objects,Rectangle(self.x-100,self.y+self.waf:getHeight()+100,self.waf:getWidth()+200,100,1,true)) --bot side
end
